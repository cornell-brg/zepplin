  ...
  generate
    always_comb begin
      casez ( inst ) //          uop        jal     raddr0 raddr1 waddr wen imm_sel op2_sel  op3_sel
        `RVI_INST_ADD:    cs( y,  OP_ADD,       j_n,     rs1,   rs2,   rd,    y,  rv_imm_type'('0),  op2_rf,   op3_x );
        `RVI_INST_SUB:    cs( y,  OP_SUB,       j_n,     rs1,   rs2,   rd,    y,  rv_imm_type'('0),  op2_rf,   op3_x );
        `RVI_INST_AND:    cs( y,  OP_AND,       j_n,     rs1,   rs2,   rd,    y,  rv_imm_type'('0),  op2_rf,   op3_x );
        `RVI_INST_OR:     cs( y,  OP_OR,        j_n,     rs1,   rs2,   rd,    y,  rv_imm_type'('0),  op2_rf,   op3_x );
        `RVI_INST_XOR:    cs( y,  OP_XOR,       j_n,     rs1,   rs2,   rd,    y,  rv_imm_type'('0),  op2_rf,   op3_x );
        `RVI_INST_SLT:    cs( y,  OP_SLT,       j_n,     rs1,   rs2,   rd,    y,  rv_imm_type'('0),  op2_rf,   op3_x );
        `RVI_INST_SLTU:   cs( y,  OP_SLTU,      j_n,     rs1,   rs2,   rd,    y,  rv_imm_type'('0),  op2_rf,   op3_x );
        `RVI_INST_SRA:    cs( y,  OP_SRA,       j_n,     rs1,   rs2,   rd,    y,  rv_imm_type'('0),  op2_rf,   op3_x );
        `RVI_INST_SRL:    cs( y,  OP_SRL,       j_n,     rs1,   rs2,   rd,    y,  rv_imm_type'('0),  op2_rf,   op3_x );
        `RVI_INST_SLL:    cs( y,  OP_SLL,       j_n,     rs1,   rs2,   rd,    y,  rv_imm_type'('0),  op2_rf,   op3_x );
        ...
        `RVI_INST_FENCE:  cs( y,  OP_ADD,       j_n,     5'b0,  5'b0,  5'b0,  n,  rv_imm_type'('0),  op2_rf,   op3_x );
        ...
        `RVM_INST_MUL:    cs( y,  OP_MUL,       j_n,     rs1,   rs2,   rd,    y,  rv_imm_type'('0),  op2_rf,   op3_x );
        `RVM_INST_MULH:   cs( y,  OP_MULH,      j_n,     rs1,   rs2,   rd,    y,  rv_imm_type'('0),  op2_rf,   op3_x );
        `RVM_INST_MULHU:  cs( y,  OP_MULHU,     j_n,     rs1,   rs2,   rd,    y,  rv_imm_type'('0),  op2_rf,   op3_x );
        `RVM_INST_MULHSU: cs( y,  OP_MULHSU,    j_n,     rs1,   rs2,   rd,    y,  rv_imm_type'('0),  op2_rf,   op3_x );
        `RVM_INST_DIV:    cs( y,  OP_DIV,       j_n,     rs1,   rs2,   rd,    y,  rv_imm_type'('0),  op2_rf,   op3_x );
        `RVM_INST_DIVU:   cs( y,  OP_DIVU,      j_n,     rs1,   rs2,   rd,    y,  rv_imm_type'('0),  op2_rf,   op3_x );
        `RVM_INST_REM:    cs( y,  OP_REM,       j_n,     rs1,   rs2,   rd,    y,  rv_imm_type'('0),  op2_rf,   op3_x );
        `RVM_INST_REMU:   cs( y,  OP_REMU,      j_n,     rs1,   rs2,   rd,    y,  rv_imm_type'('0),  op2_rf,   op3_x );
